...
export const CodexPage: React.FC<Plant> = ({
  ...
  <div className="bg-monstera-100 min-h-screen">
    ...
    <main>
      ...
      >
        <div className="flex flex-col justify-center items-center w-full bg-monstera-400 border border-y-black shadow-inner" />
      </section>
      <section className="flex justify-center items-center py-2 border-b border-black  font-alpina italic text-[16px] font-medium tracking-tight">
        {botanicalName}
      </section>
      <section className="md:flex border-b-[1px] border-black">
        <div className="grid grid-cols-5 grid-rows-[48px_36px_40px] md:w-1/2 gap-0 leading-[16px] md:border-r-[1px] md:border-black">
          ...
          <div className="flex bg-yellow-300  col-span-1 row-span-3 border-b md:border-b-0 border-r border-black items-center pl-2" />
          <div className="flex bg-[#5caebf] col-span-1 row-span-3 border-b md:border-b-0 border-r border-black items-center pl-2" />
          ...
          <div className="flex bg-gray-300 col-span-1 border-b md:border-b-0 border-r border-black items-center pl-2 text-[14px] font-[500]">
            {hardinessZones}
          </div>
          <div className="flex bg-gray-300 col-span-2 border-b md:border-b-0 border-black items-center pl-2 text-[14px] font-[500]">
            {matureSize}
          </div>
        </div>
        <div className="relative -top-[8px] flex flex-col gap-[8px] m-[24px] md:w-[50%]">
          <h2 className="relative top-[16px] font-alpina font-[500] text-[18px] md:hidden">
            Fact Sheet
          </h2>
          <div className="flex items-center w-full">
            <div className="grow h-[1px] bg-black w-24 md:opacity-0" />
