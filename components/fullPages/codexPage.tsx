...
export const CodexPage: React.FC<Plant> = ({
  ...
  <div>
    <nav className="flex justify-between my-[18px] mx-[24px] items-center">
      ...
      <h1 className="font-[Flexa] font-medium text-[24px] -letter-spacing-[1%] text-center">
        {commonName[0]}
      </h1>
      <div className="relative h-[36px] w-[36px] bg-white rounded-full">
        <div className="absolute h-[24px] w-[24px] border-[2px] border-monstera-800 rounded-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
          <div className="text-monstera-800 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[20px]">
            +
          </div>
        </div>
      </div>
    ...
    <main className="relative -top-[56px]">
      <div className="flex justify-between min-h-[72px] gap-[8px] mx-[24px] text-[#FFB800]">
        <div className="w-full rounded-[16px] border border-[#FFB800] p-[8px] flex flex-col gap-[8px] justify-between">
          <h3 className="font-bold text-[14px]">SOIL</h3>
          <h3 className="h-full text-[16px] border border-[#FFB800] rounded-[12px] px-[8px] py-[4px] leading-4 tracking-tight">
            {soilType}
          </h3>
        </div>
        <div className="w-full rounded-[16px] border border-[#FFB800] p-[8px] flex flex-col gap-[8px] justify-between">
          <h3 className="font-bold text-[14px]">TOXICITY</h3>
          <h3 className="h-full text-[16px] border border-[#FFB800] rounded-[12px] px-[8px] py-[6px] leading-4 tracking-tight">
            {toxicity || "Unknown"}
          </h3>
        </div>
        <div className="w-full rounded-[16px] border border-[#FFB800] p-[8px] flex flex-col gap-[8px] justify-between">
