  ...
  <div className="flex justify-between items-center mb-6 gap-4">
    <div className="flex gap-4">
      ...
      {/* <button
          ...
          className="flex items-center justify-center bg-water-100 h-6 w-6 
          rounded-full drop-shadow text-grey-600 font-[690] text-sm relative top-11 -left-6"
        >
          {level}
        </button> */}
    ...
    <button
      className="flex items-center justify-center bg-water-100 h-7 w-7 rounded-full drop-shadow text-md "
      onClick={(e) => {
        e.preventDefault();
        handleWateredClick();
      }}
